              ...
              <div className="px-4 py-4 space-y-3">
                ...
                <div className="flex gap-2 bg-blue-50 border border-blue-100 rounded-xl p-3">
                  ...
                  <p className="text-xs text-blue-700 leading-relaxed font-medium">
                    En el siguiente paso escanearás la CURP de cada menor. Solo aplica para menores de 19 años.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4 animate-fade-in-up">
            ...
            {verificandoDuplicado ? (
              ...
              <ConfirmarPersona
                ...
                error={errorMenor}
                edadMaxima={19}
                textoRequisito="Este beneficio es solo para menores de 19 años. Esta CURP no cumple el requisito."
              />
            )}
          </div>
        )}
